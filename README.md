...
## Representing State
Leo allows users to define compositef data s with the `struct` keyword. ad
The game board is represented by a stDdrudct called `Board`, which contains three `Row`s.
